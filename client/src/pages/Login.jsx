      ...
      <div className="max-w-md w-full space-y-8 animate-slide-up">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-505 dark:text-slate-400">
            Sign in to manage your contacts database
          </p>
        </div>
        ...
        <div className="glass-card rounded-3xl p-8 border border-slate-150/40 dark:border-slate-800/40">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold shadow-md shadow-indigo-600/10 hover:shadow-indigo-600/25 transition-all flex items-center justify-center gap-2 disabled:opacity-75 disabled:cursor-not-allowed"
            >
              {loading ? (
